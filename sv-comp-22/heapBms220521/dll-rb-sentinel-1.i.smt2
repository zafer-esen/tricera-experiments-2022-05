...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Addr) (var4 Heap)) (or (not (and (inv_main28 var4 var3 var2 var1 var0) (and (is-O_TSLL (read var4 var1)) (is-O_TSLL (read var4 var1))))) (inv_main27 (write var4 var1 (O_TSLL (TSLL var0 (prev (getTSLL (read var4 var1))) (colour (getTSLL (read var4 var1)))))) var3 var2 var1))))
...
(assert (forall ((var0 TSLL) (var1 Addr) (var2 Addr) (var3 Addr) (var4 Heap) (var5 Addr) (var6 Addr) (var7 Addr) (var8 Heap)) (or (not (and (inv_main23 var8 var7 var6 var5) (and (and (is-O_TSLL (read var8 var5)) (is-O_TSLL (read var8 var5))) (and (and (and (= var4 (write var8 var5 (O_TSLL (TSLL (next (getTSLL (read var8 var5))) (prev (getTSLL (read var8 var5))) 0)))) (= var3 var7)) (= var2 var6)) (= var1 var5))))) (inv_main28 (newHeap (alloc var4 (O_TSLL var0))) var3 var2 var1 (newAddr (alloc var4 (O_TSLL var0)))))))
...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Heap)) (or (not (and (inv_main30 var3 var2 var1 var0) (and (is-O_TSLL (read var3 var0)) (is-O_TSLL (read var3 var0))))) (inv_main32 (write var3 var0 (O_TSLL (TSLL var2 (prev (getTSLL (read var3 var0))) (colour (getTSLL (read var3 var0)))))) var2 var1 var0))))
