...
(assert (forall ((var0 Int) (var1 Addr) (var2 Int) (var3 TData) (var4 TData) (var5 Heap) (var6 Heap) (var7 Int) (var8 TData) (var9 Heap)) (or (not (and (inv_main12 var9 var8 var7) (and (and (and (and (= var6 var5) (= var4 var3)) (= var2 1)) (= var1 (lo var3))) (and (and (is-O_Int (read var9 (hi var8))) (is-O_Int (read var9 (hi var8)))) (and (and (= var5 (write var9 (hi var8) (O_Int 8))) (= var3 var8)) (= var0 var7)))))) (inv_main19 var6 var4 var2 var1 (hi var4)))))
