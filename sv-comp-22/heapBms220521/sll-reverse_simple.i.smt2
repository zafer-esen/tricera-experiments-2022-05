...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Heap)) (or (not (and (inv_main12 var2 var1 var0) (and (is-O_TSLL (read var2 var0)) (is-O_TSLL (read var2 var0))))) (inv_main14 (write var2 var0 (O_TSLL (TSLL nullAddr (data (getTSLL (read var2 var0)))))) var1 var0))))
...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Heap)) (or (not (and (inv_main38 var3 var2 var1 var0) (and (is-O_TSLL (read var3 var1)) (is-O_TSLL (read var3 var1))))) (inv_main37 (write var3 var1 (O_TSLL (TSLL var0 (data (getTSLL (read var3 var1)))))) var2 var1))))
...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Heap)) (or (not (and (inv_main27 var2 var1 var0) (and (is-O_TSLL (read var2 var0)) (is-O_TSLL (read var2 var0))))) (inv_main32 (write var2 var0 (O_TSLL (TSLL (next (getTSLL (read var2 var0))) 1))) var1 var0))))
...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Heap)) (or (not (and (inv_main39 var2 var1 var0) (and (is-O_TSLL (read var2 var0)) (is-O_TSLL (read var2 var0))))) (inv_main41 (write var2 var0 (O_TSLL (TSLL nullAddr (data (getTSLL (read var2 var0)))))) var1 var0))))
...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Heap)) (or (not (and (inv_main11 var3 var2 var1 var0) (and (is-O_TSLL (read var3 var1)) (is-O_TSLL (read var3 var1))))) (inv_main10 (write var3 var1 (O_TSLL (TSLL var0 (data (getTSLL (read var3 var1)))))) var2 var1))))
(assert (forall ((var0 TSLL) (var1 Addr) (var2 Addr) (var3 Heap) (var4 Int) (var5 Addr) (var6 Addr) (var7 Heap)) (or (not (and (inv_main14 var7 var6 var5) (and (and (not (= var4 0)) (and (is-O_TSLL (read var7 var5)) (is-O_TSLL (read var7 var5)))) (and (and (= var3 (write var7 var5 (O_TSLL (TSLL (next (getTSLL (read var7 var5))) 0)))) (= var2 var6)) (= var1 var5))))) (inv_main11 (newHeap (alloc var3 (O_TSLL var0))) var2 var1 (newAddr (alloc var3 (O_TSLL var0)))))))
