...
(assert (forall ((var0 Int) (var1 Int) (var2 Addr) (var3 Addr) (var4 Heap)) (or (not (and (inv_main28 var4 var3 var2 var1 var0) (and (is-O_node (read var4 var2)) (is-O_node (read var4 var2))))) (inv_main27 (write var4 var2 (O_node (node (next (getnode (read var4 var2))) var0 (order (getnode (read var4 var2)))))) var3 var2 var1))))
...
(assert (forall ((var0 Addr) (var1 Int) (var2 Addr) (var3 Heap)) (or (not (and (inv_main12 var3 var2 var1 var0) (and (is-O_node (read var3 var0)) (is-O_node (read var3 var0))))) (inv_main13 (write var3 var0 (O_node (node (next (getnode (read var3 var0))) var1 (order (getnode (read var3 var0)))))) var2 var1 var0))))
...
(assert (forall ((var0 Int) (var1 Addr) (var2 Addr) (var3 Heap)) (or (not (and (inv_main21 var3 var2 var1 var0) (and (is-O_node (read var3 var1)) (is-O_node (read var3 var1))))) (inv_main26 (write var3 var1 (O_node (node (next (getnode (read var3 var1))) (stock (getnode (read var3 var1))) var0))) var2 var1 var0))))
...
(assert (forall ((var0 Addr) (var1 Int) (var2 Addr) (var3 Heap)) (or (not (and (inv_main13 var3 var2 var1 var0) (and (is-O_node (read var3 var0)) (is-O_node (read var3 var0))))) (inv_main14 (write var3 var0 (O_node (node (next (getnode (read var3 var0))) (stock (getnode (read var3 var0))) 0))) var2 var1 var0))))
