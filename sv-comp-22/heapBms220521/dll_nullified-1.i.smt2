...
(assert (forall ((var0 Addr) (var1 Int) (var2 Heap)) (or (not (and (inv_main41 var2 var1 var0) (is-O_node (read var2 var0)))) (inv_main42 var2 var1 var0 (prev (getnode (read var2 var0)))))))
...
(assert (forall ((var0 Addr) (var1 Int) (var2 Heap)) (or (not (and (inv_main30 var2 var1 var0) (is-O_node (read var2 var0)))) (and (or (not (not (= 0 (data_0 (getnode (read var2 var0)))))) (inv_main34 var2 var1 var0 1)) (or (not (= 0 (data_0 (getnode (read var2 var0))))) (inv_main34 var2 var1 var0 0))))))
...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Int) (var3 Heap)) (or (not (and (inv_main42 var3 var2 var1 var0) (is-O_node (read var3 var1)))) (and (or (not (not (= 0 (data_0 (getnode (read var3 var1)))))) (inv_main46 var3 var2 var1 var0 1)) (or (not (= 0 (data_0 (getnode (read var3 var1))))) (inv_main46 var3 var2 var1 var0 0))))))
