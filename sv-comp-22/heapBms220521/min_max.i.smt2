...
(assert (forall ((var0 Int) (var1 Addr) (var2 Int) (var3 Int) (var4 Addr) (var5 Heap)) (or (not (and (inv_main10 var5 var4 var3 var2 var1) (and (is-O_node (read var5 var1)) (is-O_node (read var5 var1))))) (inv_main9 (write var5 var1 (O_node (node (next (getnode (read var5 var1))) var0))) var4 var3 var2 var1))))
