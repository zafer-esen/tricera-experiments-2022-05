...
(assert (forall ((var0 Addr) (var1 Heap) (var2 Addr) (var3 Heap) (var4 node) (var5 Addr) (var6 Heap)) (or (not (and (inv_main34 var6 var5 var4) (and (and (and (is-O_node (read var6 var5)) (is-O_node (read var6 var5))) (and (= var3 (write var6 var5 (O_node var4))) (= var2 var5))) (and (= var1 (write var3 var2 defObj)) (= var0 var2))))) (inv_main0 var1 0))))
...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Heap)) (or (not (and (inv_main20 var2 var1 var0) (and (is-O_node (read var2 var1)) (is-O_node (read var2 var1))))) (inv_main18 (write var2 var1 (O_node (node var0))) var1))))
