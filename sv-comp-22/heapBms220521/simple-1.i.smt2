...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Heap)) (or (not (and (inv_main13 var3 var2 var1 var0) (and (is-O_node (read var3 var0)) (is-O_node (read var3 var0))))) (inv_main27 (write var3 var0 (O_node (node 2 (n (getnode (read var3 var0)))))) var2 var1 var0))))
...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Heap)) (or (not (and (inv_main19 var3 var2 var1 var0) (and (is-O_node (read var3 var0)) (is-O_node (read var3 var0))))) (inv_main25 (write var3 var0 (O_node (node (h (getnode (read var3 var0))) var1))) var2 var1 var0))))
