...
(assert (forall ((var0 AddrRange) (var1 Int) (var2 Heap) (var3 Heap)) (or (not (and (= var3 emptyHeap) (and (= var2 (newBatchHeap (batchAlloc emptyHeap (O_Int var1) 100000))) (= var0 (newAddrRange (batchAlloc emptyHeap (O_Int var1) 100000)))))) (inv_main5 var2 var0 0 0))))
