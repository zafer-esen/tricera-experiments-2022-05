...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Heap)) (or (not (and (inv_main35 var3 var2 var1 var0) (and (is-O_TSLL (read var3 var1)) (is-O_TSLL (read var3 var1))))) (inv_main37 (write var3 var1 (O_TSLL (TSLL (next (getTSLL (read var3 var1))) 1))) var2 var1 var0))))
...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Addr) (var4 Heap)) (or (not (and (inv_main36 var4 var3 var2 var1 var0) (and (is-O_TSLL (read var4 var2)) (is-O_TSLL (read var4 var2))))) (inv_main35 (write var4 var2 (O_TSLL (TSLL var0 (data (getTSLL (read var4 var2)))))) var3 var2 var1))))
...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Heap)) (or (not (and (inv_main20 var2 var1 var0) (and (is-O_TSLL (read var2 var0)) (is-O_TSLL (read var2 var0))))) (inv_main22 (write var2 var0 (O_TSLL (TSLL (next (getTSLL (read var2 var0))) 1))) var1 var0))))
