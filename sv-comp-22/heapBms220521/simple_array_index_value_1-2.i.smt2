...
(assert (forall ((var0 Int) (var1 Int) (var2 AddrRange) (var3 Heap)) (or (not (and (inv_main6 var3 var2 var1 var0) (not (<= 0 (+ (+ 10000 (* (- 1) var0)) (- 1)))))) (inv_main15 var3 var2 var1 var0 0))))
