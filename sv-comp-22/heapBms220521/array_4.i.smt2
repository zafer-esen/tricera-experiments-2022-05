...
(assert (forall ((var0 AddrRange) (var1 Int) (var2 Heap) (var3 Int) (var4 Int) (var5 AddrRange) (var6 Heap)) (or (not (and (inv_main9 var6 var5 var4) (and (<= 0 (+ (+ 1023 (* (- 1) (+ var3 1))) (- 1))) (and (and (is-O_Int (read var6 (nthAddrRange var5 var4))) (is-O_Int (read var6 (nthAddrRange var5 var4)))) (and (and (= var2 (write var6 (nthAddrRange var5 var4) (O_Int var1))) (= var0 var5)) (= var3 var4)))))) (inv_main9 var2 var0 (+ var3 1)))))
(assert true)
(assert (forall ((var0 AddrRange) (var1 Int) (var2 Heap) (var3 Int) (var4 Int) (var5 AddrRange) (var6 Heap)) (or (not (and (inv_main9 var6 var5 var4) (and (not (<= 0 (+ (+ 1023 (* (- 1) (+ var3 1))) (- 1)))) (and (and (is-O_Int (read var6 (nthAddrRange var5 var4))) (is-O_Int (read var6 (nthAddrRange var5 var4)))) (and (and (= var2 (write var6 (nthAddrRange var5 var4) (O_Int var1))) (= var0 var5)) (= var3 var4)))))) (inv_main5 var2 var0 (+ var3 1)))))
(assert (forall ((var0 Int) (var1 AddrRange) (var2 Heap) (var3 Int) (var4 AddrRange) (var5 Heap)) (or (not (and (inv_main5 var5 var4 var3) (and (and (is-O_Int (read var5 (nthAddrRange var4 1023))) (is-O_Int (read var5 (nthAddrRange var4 1023)))) (and (and (= var2 (write var5 (nthAddrRange var4 1023) (O_Int 0))) (= var1 var4)) (= var0 var3))))) (inv_main12 var2 var1 0))))
(assert (forall ((var0 Int) (var1 AddrRange) (var2 Heap) (var3 Int) (var4 Int) (var5 AddrRange) (var6 Heap)) (or (not (and (inv_main12 var6 var5 var4) (and (and (not (= var3 0)) (is-O_Int (read var6 (nthAddrRange var5 var4)))) (and (and (and (= var2 var6) (= var1 var5)) (= var0 var4)) (= var3 (getInt (read var6 (nthAddrRange var5 var4)))))))) (inv_main12 var2 var1 (+ var0 1)))))
