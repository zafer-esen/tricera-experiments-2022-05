...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Heap)) (or (not (and (inv_main10 var2 var1 var0) (and (is-O_node (read var2 var1)) (is-O_node (read var2 var1))))) (inv_main17 (write var2 var1 (O_node (node 1 (n (getnode (read var2 var1)))))) var1 var0))))
