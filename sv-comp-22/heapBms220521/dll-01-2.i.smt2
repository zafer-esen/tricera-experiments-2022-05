...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Heap)) (or (not (and (inv_main112 var2 var1 var0) (and (is-O_TSLL (read var2 var0)) (= nullAddr (next (getTSLL (read var2 var0))))))) (inv_main122 (write var2 var0 defObj) var1 var0))))
...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Heap)) (or (not (and (inv_main122 var2 var1 var0) (and (is-O_TSLL (read var2 var1)) (is-O_TSLL (read var2 var1))))) (inv_main104 (write var2 var1 (O_TSLL (TSLL (next (getTSLL (read var2 var1))) (prev (getTSLL (read var2 var1))) nullAddr))) var1 var0))))
