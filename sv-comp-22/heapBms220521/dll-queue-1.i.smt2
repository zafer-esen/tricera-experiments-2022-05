...
(assert (forall ((var0 Int) (var1 Addr) (var2 Addr) (var3 Heap) (var4 Int) (var5 Addr) (var6 Addr) (var7 Heap)) (or (not (and (inv_main19 var7 var6 var5 var4) (and (and (is-O_TSLL (read var7 var5)) (is-O_TSLL (read var7 var5))) (and (and (and (= var3 (write var7 var5 (O_TSLL (TSLL (next (getTSLL (read var7 var5))) (prev (getTSLL (read var7 var5))) 1)))) (= var2 var6)) (= var1 var5)) (= var0 var4))))) (inv_main18 var3 var2 var1 1))))
(assert (forall ((var0 Int) (var1 Addr) (var2 Addr) (var3 Heap) (var4 Int) (var5 Addr) (var6 Addr) (var7 Heap)) (or (not (and (inv_main22 var7 var6 var5 var4) (and (and (is-O_TSLL (read var7 var5)) (is-O_TSLL (read var7 var5))) (and (and (and (= var3 (write var7 var5 (O_TSLL (TSLL (next (getTSLL (read var7 var5))) (prev (getTSLL (read var7 var5))) 2)))) (= var2 var6)) (= var1 var5)) (= var0 var4))))) (inv_main18 var3 var2 var1 2))))
...
(assert (forall ((var0 Int) (var1 Addr) (var2 Addr) (var3 Heap) (var4 Int) (var5 Addr) (var6 Addr) (var7 Heap)) (or (not (and (inv_main25 var7 var6 var5 var4) (and (and (is-O_TSLL (read var7 var5)) (is-O_TSLL (read var7 var5))) (and (and (and (= var3 (write var7 var5 (O_TSLL (TSLL (next (getTSLL (read var7 var5))) (prev (getTSLL (read var7 var5))) 3)))) (= var2 var6)) (= var1 var5)) (= var0 var4))))) (inv_main18 var3 var2 var1 3))))
