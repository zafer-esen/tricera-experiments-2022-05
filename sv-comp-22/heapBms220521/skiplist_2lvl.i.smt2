...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Heap)) (or (not (and (inv_main10 var2 var1 var0) (and (is-O_sl (read var2 var1)) (is-O_sl (read var2 var1))))) (inv_main9 (write var2 var1 (O_sl (sl (head (getsl (read var2 var1))) var0))) var1))))
...
(assert (forall ((var0 Addr) (var1 Heap)) (or (not (and (inv_main11 var1 var0) (and (and (is-O_sl (read var1 var0)) (is-O_sl_item (read var1 (tail (getsl (read var1 var0)))))) (is-O_sl_item (read var1 (tail (getsl (read var1 var0)))))))) (inv_main15 (write var1 (tail (getsl (read var1 var0))) (O_sl_item (sl_item nullAddr (n2 (getsl_item (read var1 (tail (getsl (read var1 var0))))))))) var0 nullAddr))))
...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Heap)) (or (not (and (inv_main12 var2 var1 var0) (and (and (is-O_sl (read var2 var1)) (is-O_sl_item (read var2 (head (getsl (read var2 var1)))))) (is-O_sl_item (read var2 (head (getsl (read var2 var1)))))))) (inv_main13 (write var2 (head (getsl (read var2 var1))) (O_sl_item (sl_item var0 (n2 (getsl_item (read var2 (head (getsl (read var2 var1))))))))) var1 var0))))
...
(assert (forall ((var0 sl_item) (var1 Addr) (var2 Heap) (var3 Addr) (var4 Addr) (var5 Heap)) (or (not (and (inv_main8 var5 var4 var3) (and (and (is-O_sl (read var5 var4)) (is-O_sl (read var5 var4))) (and (= var2 (write var5 var4 (O_sl (sl var3 (tail (getsl (read var5 var4))))))) (= var1 var4))))) (inv_main10 (newHeap (alloc var2 (O_sl_item var0))) var1 (newAddr (alloc var2 (O_sl_item var0)))))))
(assert (forall ((var0 Addr) (var1 Addr) (var2 Heap)) (or (not (and (inv_main13 var2 var1 var0) (and (and (is-O_sl (read var2 var1)) (is-O_sl_item (read var2 (head (getsl (read var2 var1)))))) (is-O_sl_item (read var2 (head (getsl (read var2 var1)))))))) (inv_main11 (write var2 (head (getsl (read var2 var1))) (O_sl_item (sl_item (n1 (getsl_item (read var2 (head (getsl (read var2 var1)))))) var0))) var1))))
...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Addr) (var4 Addr) (var5 Addr) (var6 Heap)) (or (not (and (inv_main45 var6 var5 var4 var3 var2 var1 var0) (and (is-O_sl_item (read var6 var1)) (is-O_sl_item (read var6 var1))))) (inv_main44 (write var6 var1 (O_sl_item (sl_item var0 (n2 (getsl_item (read var6 var1)))))) var5 var4 var3 var2 var1))))
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Addr) (var4 Addr) (var5 Addr) (var6 Heap)) (or (not (and (inv_main51 var6 var5 var4 var3 var2 var1 var0) (and (is-O_sl_item (read var6 var1)) (is-O_sl_item (read var6 var1))))) (inv_main50 (write var6 var1 (O_sl_item (sl_item (n1 (getsl_item (read var6 var1))) var0))) var5 var4 var3 var2 var1))))
