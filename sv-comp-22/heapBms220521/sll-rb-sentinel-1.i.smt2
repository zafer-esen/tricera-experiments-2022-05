...
(assert (forall ((var0 Addr) (var1 Heap)) (or (not (and (inv_main3 var1 var0) (and (is-O_TSLL (read var1 var0)) (is-O_TSLL (read var1 var0))))) (inv_main4 (write var1 var0 (O_TSLL (TSLL (next (getTSLL (read var1 var0))) 1))) var0))))
...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Heap)) (or (not (and (inv_main24 var3 var2 var1 var0) (and (is-O_TSLL (read var3 var0)) (is-O_TSLL (read var3 var0))))) (inv_main26 (write var3 var0 (O_TSLL (TSLL var2 (colour (getTSLL (read var3 var0)))))) var2 var1 var0))))
...
(assert (forall ((var0 TSLL) (var1 Addr) (var2 Addr) (var3 Addr) (var4 Heap) (var5 Addr) (var6 Addr) (var7 Addr) (var8 Heap)) (or (not (and (inv_main19 var8 var7 var6 var5) (and (and (is-O_TSLL (read var8 var5)) (is-O_TSLL (read var8 var5))) (and (and (and (= var4 (write var8 var5 (O_TSLL (TSLL (next (getTSLL (read var8 var5))) 0)))) (= var3 var7)) (= var2 var6)) (= var1 var5))))) (inv_main23 (newHeap (alloc var4 (O_TSLL var0))) var3 var2 var1 (newAddr (alloc var4 (O_TSLL var0)))))))
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Addr) (var4 Heap)) (or (not (and (inv_main14 var4 var3 var2 var1 var0) (and (is-O_TSLL (read var4 var1)) (is-O_TSLL (read var4 var1))))) (inv_main13 (write var4 var1 (O_TSLL (TSLL var0 (colour (getTSLL (read var4 var1)))))) var3 var2 var1))))
...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Heap)) (or (not (and (inv_main18 var3 var2 var1 var0) (and (is-O_TSLL (read var3 var0)) (is-O_TSLL (read var3 var0))))) (inv_main9 (write var3 var0 (O_TSLL (TSLL (next (getTSLL (read var3 var0))) 1))) var2 var1 var0))))
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Heap)) (or (not (and (inv_main26 var3 var2 var1 var0) (and (is-O_TSLL (read var3 var0)) (is-O_TSLL (read var3 var0))))) (inv_main9 (write var3 var0 (O_TSLL (TSLL (next (getTSLL (read var3 var0))) 1))) var2 var1 var0))))
...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Addr) (var4 Heap)) (or (not (and (inv_main23 var4 var3 var2 var1 var0) (and (is-O_TSLL (read var4 var1)) (is-O_TSLL (read var4 var1))))) (inv_main22 (write var4 var1 (O_TSLL (TSLL var0 (colour (getTSLL (read var4 var1)))))) var3 var2 var1))))
...
(assert (forall ((var0 TSLL) (var1 Addr) (var2 Heap) (var3 Addr) (var4 Heap)) (or (not (and (inv_main4 var4 var3) (and (and (is-O_TSLL (read var4 var3)) (is-O_TSLL (read var4 var3))) (and (= var2 (write var4 var3 (O_TSLL (TSLL nullAddr (colour (getTSLL (read var4 var3))))))) (= var1 var3))))) (inv_main6 (newHeap (alloc var2 (O_TSLL var0))) var1 (newAddr (alloc var2 (O_TSLL var0)))))))
...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Heap)) (or (not (and (inv_main6 var2 var1 var0) (and (is-O_TSLL (read var2 var0)) (is-O_TSLL (read var2 var0))))) (inv_main7 (write var2 var0 (O_TSLL (TSLL var1 (colour (getTSLL (read var2 var0)))))) var1 var0))))
