...
(assert (forall ((var0 Int) (var1 Addr) (var2 TData) (var3 TData) (var4 TData) (var5 Heap) (var6 Heap) (var7 Int) (var8 TData) (var9 Heap)) (or (not (and (inv_main12 var9 var8 var7) (and (and (and (and (= var6 var5) (= var4 var3)) (= var2 var3)) (= var1 (lo var3))) (and (and (is-O_Int (read var9 (hi var8))) (is-O_Int (read var9 (hi var8)))) (and (and (= var5 (write var9 (hi var8) (O_Int 8))) (= var3 var8)) (= var0 var7)))))) (inv_main18 var6 var4 var2 var1 (hi var2)))))
...
(assert (forall ((var0 Int) (var1 TData) (var2 Heap)) (or (not (and (inv_main10 var2 var1 var0) (and (is-O_Int (read var2 (lo var1))) (is-O_Int (read var2 (lo var1)))))) (inv_main12 (write var2 (lo var1) (O_Int 4)) var1 var0))))
