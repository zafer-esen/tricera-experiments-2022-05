...
(assert (forall ((var0 Addr) (var1 Int) (var2 Addr) (var3 Heap)) (or (not (and (inv_main9 var3 var2 var1 var0) (and (is-O_item (read var3 var0)) (is-O_item (read var3 var0))))) (inv_main10 (write var3 var0 (O_item (item var2 (data (getitem (read var3 var0)))))) var2 var1 var0))))
...
(assert (forall ((var0 item) (var1 Addr) (var2 Int) (var3 Addr) (var4 Heap) (var5 Int) (var6 Addr) (var7 Addr) (var8 Int) (var9 Addr) (var10 Heap)) (or (not (and (inv_main12 var10 var9 var8 var7 var6) (and (not (= var5 0)) (and (and (is-O_item (read var10 var7)) (is-O_item (read var10 var7))) (and (and (and (= var4 (write var10 var7 (O_item (item (next (getitem (read var10 var7))) var6)))) (= var3 var9)) (= var2 var8)) (= var1 var7)))))) (inv_main9 (newHeap (alloc var4 (O_item var0))) var1 1 (newAddr (alloc var4 (O_item var0)))))))
