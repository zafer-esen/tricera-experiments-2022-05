...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Heap)) (or (not (and (inv_main31 var3 var2 var1 var0) (is-O_node (read var3 var2)))) (inv_main34 var3 var2 var1 var0 (val (getnode (read var3 var2)))))))
...
(assert (forall ((var0 Int) (var1 Addr) (var2 Addr) (var3 Addr) (var4 Heap)) (or (not (and (inv_main33 var4 var3 var2 var1 var0) (is-O_node (read var4 var3)))) (inv_main23 (write var4 var3 (O_node (node (+ var0 1) (next (getnode (read var4 var3)))))) var3 var2 var1))))
(assert (forall ((var0 Int) (var1 Addr) (var2 Addr) (var3 Addr) (var4 Heap) (var5 Int)) (or (not (and (inv_main34 var4 var3 var2 var1 var0) (is-O_node (read var4 var3)))) (or (not (and (and (and (<= 0 (+ (+ 2 (* (- 1) (+ var0 (* (- 2) var5)))) (- 1))) (<= 0 (+ (+ 2 (* 1 (+ var0 (* (- 2) var5)))) (- 1)))) (or (not (<= 0 (+ (+ var0 (* (- 2) var5)) (- 1)))) (<= 0 (+ var0 (- 1))))) (or (not (<= 0 (+ (* (- 1) (+ var0 (* (- 2) var5))) (- 1)))) (<= 0 (+ (* (- 1) var0) (- 1)))))) (inv_main23 (write var4 var3 (O_node (node var5 (next (getnode (read var4 var3)))))) var3 var2 var1)))))
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Heap)) (or (not (and (inv_main30 var3 var2 var1 var0) (is-O_node (read var3 var2)))) (inv_main33 var3 var2 var1 var0 (val (getnode (read var3 var2)))))))
