...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Heap)) (or (not (and (inv_main16 var2 var1 var0) (and (is-O_node (read var2 var1)) (is-O_node (read var2 var1))))) (inv_main14 (write var2 var1 (O_node (node var0))) var1))))
...
(assert (forall ((var0 node) (var1 Addr) (var2 Heap)) (or (not (and (inv_main26 var2 var1 var0) (and (is-O_node (read var2 var1)) (is-O_node (read var2 var1))))) (inv_main25 (write var2 var1 (O_node var0)) var1))))
