...
(assert (forall ((var0 Int) (var1 Heap) (var2 Addr) (var3 Heap) (var4 Addr) (var5 Heap)) (or (not (and (and (max4 var5 var4 var3 var2) (max_post var5 (left (getnode (read var5 var4))) var1 var0)) (is-O_node (read var5 var4)))) (max5 var1 var4 var3 var2 var0))))
(assert (forall ((var0 Int) (var1 Heap) (var2 Int) (var3 Addr) (var4 Heap) (var5 Addr) (var6 Heap)) (or (not (and (and (max5 var6 var5 var4 var3 var2) (max_post var6 (right (getnode (read var6 var5))) var1 var0)) (is-O_node (read var6 var5)))) (max6 var1 var5 var4 var3 var2 var0))))
...
(assert (forall ((var0 Int) (var1 Addr) (var2 Heap) (var3 Heap)) (or (not (and (nondet_tree8 var3 var2 var1) (and (is-O_node (read var3 var1)) (is-O_node (read var3 var1))))) (nondet_tree7 (write var3 var1 (O_node (node var0 (left (getnode (read var3 var1))) (right (getnode (read var3 var1)))))) var2 var1))))
(assert (forall ((var0 Addr) (var1 Heap) (var2 Heap)) (or (not (nondet_tree7 var2 var1 var0)) (nondet_tree10 var2 var1 var0))))
(assert (forall ((var0 Addr) (var1 Heap) (var2 Addr) (var3 Heap) (var4 Heap)) (or (not (and (and (nondet_tree10 var4 var3 var2) (nondet_tree_post var4 var1 var0)) (and (is-O_node (read var1 var2)) (is-O_node (read var1 var2))))) (nondet_tree9 (write var1 var2 (O_node (node (data (getnode (read var1 var2))) var0 (right (getnode (read var1 var2)))))) var3 var2))))
(assert (forall ((var0 Addr) (var1 Heap) (var2 Heap)) (or (not (nondet_tree9 var2 var1 var0)) (nondet_tree12 var2 var1 var0))))
(assert (forall ((var0 Addr) (var1 Heap) (var2 Addr) (var3 Heap) (var4 Heap)) (or (not (and (and (nondet_tree12 var4 var3 var2) (nondet_tree_post var4 var1 var0)) (and (is-O_node (read var1 var2)) (is-O_node (read var1 var2))))) (nondet_tree11 (write var1 var2 (O_node (node (data (getnode (read var1 var2))) (left (getnode (read var1 var2))) var0))) var3 var2))))
...
(assert (forall ((var0 Addr) (var1 Heap) (var2 Addr) (var3 Heap)) (or (not (and (max4 var3 var2 var1 var0) (is-O_node (read var3 var2)))) (max_pre var3 (left (getnode (read var3 var2)))))))
...
(assert (forall ((var0 Int) (var1 Addr) (var2 Heap) (var3 Addr) (var4 Heap)) (or (not (and (max5 var4 var3 var2 var1 var0) (is-O_node (read var4 var3)))) (max_pre var4 (right (getnode (read var4 var3)))))))
(assert (forall ((var0 Addr) (var1 Heap) (var2 Heap)) (not (and (nondet_tree8 var2 var1 var0) (not (is-O_node (read var2 var0)))))))
(assert (forall ((var0 Addr) (var1 Heap) (var2 Heap)) (not (and (nondet_tree8 var2 var1 var0) (and (is-O_node (read var2 var0)) (not (is-O_node (read var2 var0))))))))
...
(assert (forall ((var0 Addr) (var1 Heap) (var2 Addr) (var3 Heap) (var4 Heap)) (not (and (and (nondet_tree10 var4 var3 var2) (nondet_tree_post var4 var1 var0)) (and (is-O_node (read var1 var2)) (not (is-O_node (read var1 var2))))))))
...
(assert (forall ((var0 Addr) (var1 Heap) (var2 Addr) (var3 Heap) (var4 Heap)) (not (and (and (nondet_tree12 var4 var3 var2) (nondet_tree_post var4 var1 var0)) (and (is-O_node (read var1 var2)) (not (is-O_node (read var1 var2))))))))
(check-sat)
