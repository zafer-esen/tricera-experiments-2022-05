...
(assert (forall ((var0 Int) (var1 Addr) (var2 Addr) (var3 Addr) (var4 Heap)) (or (not (and (inv_main27 var4 var3 var2 var1 var0) (and (is-O_node (read var4 var3)) (is-O_node (read var4 var3))))) (inv_main33 (write var4 var3 (O_node (node (h (getnode (read var4 var3))) (flag (getnode (read var4 var3))) var1))) var3 var2 var1 var0))))
...
(assert (forall ((var0 Int) (var1 Int) (var2 Addr) (var3 Addr) (var4 Addr) (var5 Heap)) (or (not (and (inv_main21 var5 var4 var3 var2 var1) (and (is-O_node (read var5 var4)) (is-O_node (read var5 var4))))) (inv_main20 (write var5 var4 (O_node (node (h (getnode (read var5 var4))) var0 (n (getnode (read var5 var4)))))) var4 var3 var2 var1))))
...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Heap) (var4 Addr) (var5 Addr) (var6 Addr) (var7 Heap)) (or (not (and (inv_main6 var7 var6 var5 var4) (and (and (is-O_node (read var7 var5)) (is-O_node (read var7 var5))) (and (and (and (= var3 (write var7 var5 (O_node (node (h (getnode (read var7 var5))) (flag (getnode (read var7 var5))) 0)))) (= var2 var6)) (= var1 var5)) (= var0 var4))))) (inv_main14 var3 var1 var1 var0 0))))
