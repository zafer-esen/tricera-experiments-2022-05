...
(assert (forall ((var0 Int) (var1 Int) (var2 Int) (var3 Int) (var4 Int) (var5 Int)) (or (not (and (inv_main11 var5 var4 var3 var2 var1 var0) (<= 0 (+ (+ 50 (* (- 1) var5)) (- 1))))) (inv_main19 (+ var5 1) var4 var3 var2 var1 var0))))
...
(assert (forall ((var0 Int) (var1 Int) (var2 Int) (var3 Int) (var4 Int) (var5 Int)) (or (not (and (inv_main10 var5 var4 var3 var2 var1 var0) (and (<= 0 (+ var1 (* (- 1) var0))) (<= 0 (+ (+ 50 (* (- 1) var5)) (- 1)))))) (inv_main10 (+ var5 1) var4 var3 var2 var1 (* 2 var0)))))
(assert (forall ((var0 Int) (var1 Int) (var2 Int) (var3 Int) (var4 Int) (var5 Int)) (or (not (and (inv_main10 var5 var4 var3 var2 var1 var0) (not (<= 0 (+ (+ 50 (* (- 1) var5)) (- 1)))))) (inv_main11 (+ var5 1) var4 var3 var2 var1 var0))))
(assert (forall ((var0 Int) (var1 Int) (var2 Int) (var3 Int) (var4 Int) (var5 Int)) (or (not (and (inv_main10 var5 var4 var3 var2 var1 var0) (and (not (<= 0 (+ var1 (* (- 1) var0)))) (<= 0 (+ (+ 50 (* (- 1) var5)) (- 1)))))) (inv_main11 (+ var5 1) var4 var3 var2 var1 var0))))
...
(assert (forall ((var0 Int) (var1 Int) (var2 Int) (var3 Int) (var4 Int) (var5 Int)) (or (not (and (inv_main11 var5 var4 var3 var2 var1 var0) (not (<= 0 (+ (+ 50 (* (- 1) var5)) (- 1)))))) (inv_main18 (+ var5 1) var4 var3 var2 var1 var0))))
