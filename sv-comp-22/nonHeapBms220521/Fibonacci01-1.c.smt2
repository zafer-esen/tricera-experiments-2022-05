...
(assert inv_main2)
(assert (forall ((var0 Int)) (or (not (and inv_main2 (and (not (<= 0 (+ (+ var0 (- 46)) (- 1)))) (not (= var0 (- 2147483648)))))) (inv_main5 var0))))
(assert (forall ((var0 Int) (var1 Int)) (or (not (and (and (inv_main5 var1) (fibonacci_post var1 var0)) (not (<= 0 (+ var0 (* (- 1) (+ var1 (- 1)))))))) (inv_main10 var1 var0))))
