...
(assert inv_main2)
(assert (forall ((var0 Int) (var1 Int)) (or (not (and (and (inv_main4 var1) (fibonacci_post var1 var0)) (and (not (<= 0 (+ (+ 8 (* (- 1) var1)) (- 1)))) (not (<= 0 (+ var0 (- 34))))))) (inv_main7 var1 var0))))
(assert (forall ((var0 Int)) (or (not inv_main2) (inv_main4 var0))))
(assert (forall ((var0 Int)) (or (not (inv_main4 var0)) (fibonacci_pre var0))))
