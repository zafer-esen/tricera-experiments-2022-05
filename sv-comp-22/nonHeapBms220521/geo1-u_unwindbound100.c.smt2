...
(assert (forall ((var0 Int) (var1 Int) (var2 Int) (var3 Int) (var4 Int) (var5 Int) (var6 Int) (var7 Int)) (or (not (and (inv_main4 var7 var6 var5 var4 var3 var2) (and (<= 0 (+ (+ 100 (* (- 1) var7)) (- 1))) (and (<= 0 var1) (<= 0 var0))))) (inv_main13 (+ var7 1) var0 var1 1 var0 1))))
...
(assert (forall ((var0 Int) (var1 Int) (var2 Int) (var3 Int) (var4 Int) (var5 Int) (var6 Int) (var7 Int)) (or (not (and (inv_main4 var7 var6 var5 var4 var3 var2) (and (not (<= 0 (+ (+ 100 (* (- 1) var7)) (- 1)))) (and (<= 0 var1) (<= 0 var0))))) (inv_main22 (+ var7 1) var0 var1 (* 1 (+ var0 (- 1))) var0 1))))
