...
(assert (forall ((var0 Int) (var1 Int) (var2 Int)) (or (not (and (and (inv_main10 var2 var1) (ackermann_post var2 var1 var0)) (and (and (= var2 2) (= var1 2)) (not (= var0 7))))) (inv_main15 var2 var1 var0))))
