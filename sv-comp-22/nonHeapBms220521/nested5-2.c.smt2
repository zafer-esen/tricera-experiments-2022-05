...
(assert (forall ((var0 Int) (var1 Int) (var2 Int) (var3 Int) (var4 Int)) (or (not (and (inv_main22 var4 var3 var2 var1 var0) (<= 0 (+ (+ 268435455 (* (- 1) var0)) (- 1))))) (inv_main22 var4 var3 var2 var1 (+ var0 1)))))
...
(assert (forall ((var0 Int) (var1 Int) (var2 Int) (var3 Int) (var4 Int)) (or (not (and (inv_main22 var4 var3 var2 var1 var0) (not (<= 0 (+ (+ 268435455 (* (- 1) var0)) (- 1)))))) (inv_main21 var4 var3 var2 var1 var0))))
(assert (forall ((var0 Int) (var1 Int) (var2 Int) (var3 Int) (var4 Int) (var5 Int) (var6 Int)) (not (and (inv_main21 var4 var3 var2 var1 var0) (not (or (not (and (and (and (and (<= 0 (+ (+ 4 (* (- 1) var5)) (- 1))) (<= 0 (+ (+ 4 (* 1 var5)) (- 1)))) (or (not (<= 0 (+ var5 (- 1)))) (<= 0 (+ var0 (- 1))))) (or (not (<= 0 (+ (* (- 1) var5) (- 1)))) (<= 0 (+ (* (- 1) var0) (- 1))))) (= var0 (+ (* 4 var6) var5)))) (= var5 0)))))))
(check-sat)
