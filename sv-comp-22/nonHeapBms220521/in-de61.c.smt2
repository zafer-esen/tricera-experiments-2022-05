...
(assert (forall ((var0 Int) (var1 Int) (var2 Int) (var3 Int)) (or (not (and (inv_main19 var3 var2 var1 var0) (<= 0 (+ var1 (- 1))))) (inv_main19 var3 var2 (+ var1 (- 1)) (+ var0 1)))))
...
(assert (forall ((var0 Int) (var1 Int) (var2 Int) (var3 Int)) (not (and (inv_main22 var3 var2 var1 var0) (not (= var0 var3))))))
(check-sat)
