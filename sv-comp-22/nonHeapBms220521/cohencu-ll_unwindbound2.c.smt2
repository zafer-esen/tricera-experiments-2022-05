...
(assert (forall ((var0 Int) (var1 Int) (var2 Int) (var3 Int) (var4 Int) (var5 Int) (var6 Int)) (or (not (and (inv_main4 var6 var5 var4 var3 var2 var1) (not (<= 0 (+ (+ 2 (* (- 1) var6)) (- 1)))))) (inv_main11 (+ var6 1) var0 0 0 1 6))))
(assert (forall ((var0 Int) (var1 Int) (var2 Int) (var3 Int) (var4 Int) (var5 Int)) (or (not (and (inv_main18 var5 var4 var3 var2 var1 var0) (and (not (<= 0 (+ (+ 2 (* (- 1) var5)) (- 1)))) (<= 0 (+ var4 (* (- 1) var3)))))) (inv_main11 (+ var5 1) var4 (+ var3 1) (+ var2 var1) (+ var1 var0) (+ var0 6)))))
...
(assert (forall ((var0 Int) (var1 Int) (var2 Int) (var3 Int) (var4 Int) (var5 Int) (var6 Int)) (or (not (and (inv_main4 var6 var5 var4 var3 var2 var1) (<= 0 (+ (+ 2 (* (- 1) var6)) (- 1))))) (inv_main12 (+ var6 1) var0 0 0 1 6))))
(assert (forall ((var0 Int) (var1 Int) (var2 Int) (var3 Int) (var4 Int) (var5 Int)) (or (not (and (inv_main18 var5 var4 var3 var2 var1 var0) (and (<= 0 (+ (+ 2 (* (- 1) var5)) (- 1))) (<= 0 (+ var4 (* (- 1) var3)))))) (inv_main12 (+ var5 1) var4 (+ var3 1) (+ var2 var1) (+ var1 var0) (+ var0 6)))))
