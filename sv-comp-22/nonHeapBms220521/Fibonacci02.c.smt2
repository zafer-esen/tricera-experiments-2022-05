...
(assert (inv_main3 9))
(assert (forall ((var0 Int) (var1 Int)) (or (not (and (and (inv_main3 var1) (fibonacci_post var1 var0)) (not (= var0 34)))) (inv_main6 var1 var0))))
(assert (forall ((var0 Int)) (or (not (inv_main3 var0)) (fibonacci_pre var0))))
