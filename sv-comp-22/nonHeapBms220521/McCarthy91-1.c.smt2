...
(assert inv_main2)
(assert (forall ((var0 Int) (var1 Int)) (or (not (and (and (inv_main4 var1) (f91_post var1 var0)) (and (not (= var0 91)) (or (not (<= 0 (+ (+ var1 (- 102)) (- 1)))) (not (= var0 (+ var1 (- 10)))))))) (inv_main7 var1 var0))))
