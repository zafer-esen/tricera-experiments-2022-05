...
(assert (forall ((var0 Int) (var1 Int) (var2 Int) (var3 Int)) (or (not (and (inv_main13 var3 var2 var1 var0) (<= 0 (+ var2 (- 1))))) (inv_main13 var3 (+ var2 (- 1)) var1 (+ var0 1)))))
...
(assert (forall ((var0 Int) (var1 Int) (var2 Int) (var3 Int)) (not (and (inv_main16 var3 var2 var1 var0) (not (= var0 (* 2 var3)))))))
(check-sat)
