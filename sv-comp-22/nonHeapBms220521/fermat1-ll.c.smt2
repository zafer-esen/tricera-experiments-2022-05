...
(assert (forall ((var0 Int) (var1 Int) (var2 Int) (var3 Int) (var4 Int)) (or (not (and (inv_main37 var4 var3 var2 var1 var0) (not (<= 0 (+ (* (- 1) var0) (- 1)))))) (inv_main25 var4 var3 var2 var1 var0))))
(assert (forall ((var0 Int) (var1 Int) (var2 Int) (var3 Int) (var4 Int)) (or (not (and (inv_main25 var4 var3 var2 var1 var0) (not (= var0 0)))) (inv_main31 var4 var3 var2 var1 var0))))
(assert (forall ((var0 Int) (var1 Int) (var2 Int) (var3 Int) (var4 Int)) (or (not (and (inv_main31 var4 var3 var2 var1 var0) (<= 0 (+ var0 (- 1))))) (inv_main31 var4 var3 var2 (+ var1 2) (+ var0 (* (- 1) var1))))))
...
(assert (forall ((var0 Int) (var1 Int) (var2 Int) (var3 Int) (var4 Int)) (or (not (and (inv_main31 var4 var3 var2 var1 var0) (not (<= 0 (+ var0 (- 1)))))) (inv_main37 var4 var3 var2 var1 var0))))
(assert (forall ((var0 Int) (var1 Int) (var2 Int) (var3 Int) (var4 Int)) (or (not (and (inv_main37 var4 var3 var2 var1 var0) (<= 0 (+ (* (- 1) var0) (- 1))))) (inv_main37 var4 var3 (+ var2 2) var1 (+ var0 var2)))))
...
(assert (forall ((var0 Int) (var1 Int) (var2 Int) (var3 Int) (var4 Int)) (not (and (inv_main31 var4 var3 var2 var1 var0) (not (= (* 4 (+ var4 var0)) (+ (+ (+ (* var2 var2) (* (- 1) (* var1 var1))) (* (- 2) var2)) (* 2 var1))))))))
