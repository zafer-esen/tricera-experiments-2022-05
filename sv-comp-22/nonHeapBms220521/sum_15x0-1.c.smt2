...
(assert (inv_main4 15 0))
(assert (forall ((var0 Int) (var1 Int) (var2 Int)) (or (not (and (and (inv_main4 var2 var1) (sum_post var2 var1 var0)) (not (= var0 (+ var2 var1))))) (inv_main6 var2 var1 var0))))
