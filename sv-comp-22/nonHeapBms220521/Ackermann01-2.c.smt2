...
(assert inv_main2)
(assert (forall ((var0 Int) (var1 Int) (var2 Int)) (or (not (and (and (inv_main10 var2 var1) (ackermann_post var2 var1 var0)) (and (and (not (<= 0 (+ (* (- 1) var2) (- 1)))) (not (<= 0 (+ (* (- 1) var1) (- 1))))) (not (<= 0 var0))))) (inv_main15 var2 var1 var0))))
