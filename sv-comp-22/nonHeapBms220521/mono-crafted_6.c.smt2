...
(assert (forall ((var0 Int) (var1 Int) (var2 Int)) (or (not (and (inv_main4 var2 var1 var0) (and (<= 0 (+ (+ 750000 (* (- 1) var2)) (- 1))) (and (not (<= 0 (+ (+ 500000 (* (- 1) var2)) (- 1)))) (<= 0 (+ (+ 1000000 (* (- 1) var2)) (- 1))))))) (inv_main4 (+ var2 1) (+ var1 1) var0))))
(assert (forall ((var0 Int) (var1 Int) (var2 Int)) (or (not (and (inv_main4 var2 var1 var0) (and (not (<= 0 (+ (+ 750000 (* (- 1) var2)) (- 1)))) (and (not (<= 0 (+ (+ 500000 (* (- 1) var2)) (- 1)))) (<= 0 (+ (+ 1000000 (* (- 1) var2)) (- 1))))))) (inv_main4 (+ var2 2) (+ var1 1) var0))))
...
(assert (forall ((var0 Int) (var1 Int) (var2 Int)) (not (and (inv_main5 var2 var1 var0) (not (= var2 1000000))))))
(check-sat)
