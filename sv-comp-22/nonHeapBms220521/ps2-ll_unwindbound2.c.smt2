...
(assert (forall ((var0 Int) (var1 Int) (var2 Int) (var3 Int) (var4 Int)) (or (not (and (inv_main11 var4 var3 var2 var1 var0) (and (<= 0 (+ (+ 2 (* (- 1) var4)) (- 1))) (<= 0 (+ (+ var3 (* (- 1) var0)) (- 1)))))) (inv_main11 (+ var4 1) var3 (+ var2 1) (+ (+ var2 1) var1) (+ var0 1)))))
...
(assert (forall ((var0 Int) (var1 Int) (var2 Int) (var3 Int) (var4 Int)) (or (not (and (inv_main11 var4 var3 var2 var1 var0) (and (not (<= 0 (+ (+ 2 (* (- 1) var4)) (- 1)))) (<= 0 (+ (+ var3 (* (- 1) var0)) (- 1)))))) (inv_main10 (+ var4 1) var3 (+ var2 1) (+ (+ var2 1) var1) (+ var0 1)))))
