...
(assert (forall ((var0 Int) (var1 Int)) (or (not (and (inv_main4 var1 var0) (and (<= 0 (+ (+ 500000 (* (- 1) var1)) (- 1))) (<= 0 (+ (+ 1000000 (* (- 1) var1)) (- 1)))))) (inv_main4 (+ var1 1) (+ var0 1)))))
...
(assert (forall ((var0 Int) (var1 Int)) (not (and (inv_main5 var1 var0) (= var0 0)))))
(check-sat)
