...
(assert (forall ((var0 Int) (var1 Int) (var2 Int) (var3 Int) (var4 Int) (var5 Int)) (or (not (and (inv_main4 var5 var4 var3 var2 var1) (<= 0 (+ (+ 5 (* (- 1) var5)) (- 1))))) (inv_main11 (+ var5 1) var0 0 1 1))))
(assert (forall ((var0 Int) (var1 Int) (var2 Int) (var3 Int) (var4 Int)) (or (not (and (inv_main15 var4 var3 var2 var1 var0) (and (<= 0 (+ (+ 5 (* (- 1) var4)) (- 1))) (<= 0 (+ var3 (* (- 1) var1)))))) (inv_main11 (+ var4 1) var3 (+ var2 1) (+ var1 (+ var0 2)) (+ var0 2)))))
...
(assert (forall ((var0 Int) (var1 Int) (var2 Int) (var3 Int) (var4 Int) (var5 Int)) (or (not (and (inv_main4 var5 var4 var3 var2 var1) (not (<= 0 (+ (+ 5 (* (- 1) var5)) (- 1)))))) (inv_main10 (+ var5 1) var0 0 1 1))))
(assert (forall ((var0 Int) (var1 Int) (var2 Int) (var3 Int) (var4 Int)) (or (not (and (inv_main15 var4 var3 var2 var1 var0) (and (not (<= 0 (+ (+ 5 (* (- 1) var4)) (- 1)))) (<= 0 (+ var3 (* (- 1) var1)))))) (inv_main10 (+ var4 1) var3 (+ var2 1) (+ var1 (+ var0 2)) (+ var0 2)))))
