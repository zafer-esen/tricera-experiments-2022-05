...
(assert inv_main2)
(assert (forall ((var0 Int) (var1 Int)) (or (not (and (and (inv_main4 var1) (id_post var1 var0)) (= var0 3))) (inv_main6 var1 var0))))
...
(assert (forall ((var0 Int) (var1 Int) (var2 Int)) (or (not (and (id6 var2 var1 var0) (<= 0 (+ (+ var0 (- 2)) (- 1))))) (id8 var2 var1 var0))))
(assert (forall ((var0 Int) (var1 Int) (var2 Int)) (or (not (and (id6 var2 var1 var0) (not (<= 0 (+ (+ var0 (- 2)) (- 1)))))) (id9 var2 var1 var0))))
(assert (forall ((var0 Int) (var1 Int) (var2 Int)) (or (not (id8 var2 var1 var0)) (id1 var2 var1 2))))
