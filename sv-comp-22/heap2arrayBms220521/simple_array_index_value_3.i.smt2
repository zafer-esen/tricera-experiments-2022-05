...
(assert (forall ((var0 AddrRange) (var1 Int) (var2 Heap) (var3 Heap)) (or (not (and (batchAllocHeapPostHeap emptyHeap var2 (O_UInt var1) 10000) (and (and (= var3 emptyHeap) (= var0 (AddrRange (ite (<= 0 9999) (+ (HeapSize emptyHeap) 1) (HeapSize emptyHeap)) 10000))) true))) (inv_main5 var2 var0 0 0))))
(assert (forall ((var0 AddrRange) (var1 Int) (var2 Heap) (var3 Heap)) (or (not (and (and (= var3 emptyHeap) (= var0 (AddrRange (ite (<= 0 9999) (+ (HeapSize emptyHeap) 1) (HeapSize emptyHeap)) 10000))) true)) (batchAllocHeap emptyHeap emptyHeap (O_UInt var1) 10000 10000))))
...
(assert (forall ((var0 Int) (var1 Int) (var2 AddrRange) (var3 Heap)) (or (not (and (and (inv_main11 var3 var2 var1 var0) (= (getUInt (readHeap var3 (nthAddrRange var2 var1))) (* 2 var1))) (is-O_UInt (readHeap var3 (nthAddrRange var2 var1))))) (inv_main14 var3 var2 var1 var0 1))))
(assert (forall ((var0 Int) (var1 Int) (var2 AddrRange) (var3 Heap)) (or (not (and (inv_main5 var3 var2 var1 var0) (not (<= 0 (+ (+ (* (- 1) var1) 10000) (* (- 1) 1)))))) (inv_main11 var3 var2 0 var0))))
(assert (forall ((var0 Int) (var1 Int) (var2 Int) (var3 AddrRange) (var4 Heap)) (or (not (and (inv_main14 var4 var3 var2 var1 var0) (<= 0 (+ (+ (* (- 1) (+ var2 1)) 10000) (* (- 1) 1))))) (inv_main11 var4 var3 (+ var2 1) var1))))
(assert (forall ((var0 Int) (var1 Int) (var2 AddrRange) (var3 Heap) (var4 Int) (var5 Int) (var6 AddrRange) (var7 Heap)) (or (not (and (and (and (and (and (and (inv_main7 var7 var6 var5 var4) (= var0 var4)) (= var1 var5)) (= var2 var6)) (= var3 (writeHeap var7 (nthAddrRange var6 var5) (O_UInt var4)))) (is-O_UInt (readHeap var7 (nthAddrRange var6 var5)))) (is-O_UInt (readHeap var7 (nthAddrRange var6 var5))))) (inv_main5 var3 var2 (+ var1 1) (+ var0 2)))))
