...
(assert (forall ((var0 Addr) (var1 Int) (var2 Addr) (var3 Int) (var4 Int) (var5 Heap) (var6 Addr) (var7 Addr) (var8 Int) (var9 Addr) (var10 Int) (var11 Int) (var12 Heap) (var13 Addr) (var14 Addr) (var15 Int) (var16 Addr) (var17 Int) (var18 Int) (var19 Heap)) (or (not (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (inv_main45 var19 var18 var17 var16 var15 var14) (= var13 var6)) (= var0 var7)) (= var1 var8)) (= var2 var9)) (= var3 var10)) (= var4 var11)) (= var5 (writeHeap var12 var7 defObj))) (= var6 (next (getnode (readHeap var19 var14))))) (= var7 var14)) (= var8 var15)) (= var9 var16)) (= var10 var17)) (= var11 var18)) (= var12 var19)) (is-O_node (readHeap var19 var14))) (not (= var13 nullAddr)))) (inv_main42 var5 var4 var3 var2 (+ var1 1) var13))))
