...
(assert (forall ((var0 Int) (var1 AddrRange) (var2 Heap)) (or (not (and (batchAllocHeapPostHeap emptyHeap var2 (O_S (S 0)) 1000000) (and true (= var1 (AddrRange (ite (<= 0 999999) (+ (HeapSize emptyHeap) 1) (HeapSize emptyHeap)) 1000000))))) (inv_main3 var2 var1 var0))))
...
(assert (forall ((var0 Int) (var1 AddrRange) (var2 Heap)) (or (not (and (inv_main5 var2 var1 var0) (not (<= 0 (+ (+ (* (- 1) var0) 1000000) (* (- 1) 1)))))) (inv_main12 var2 var1 0))))
(assert (forall ((var0 Int) (var1 AddrRange) (var2 Heap) (var3 Int)) (or (not (and (and (and (and (and (inv_main5 var2 var1 var0) (<= 0 (+ (+ (* (- 1) var0) 1000000) (* (- 1) 1)))) (<= 0 (+ (+ (* (- 1) var3) var0) (* (- 1) 1)))) (not (<= 0 (+ (* (- 1) (+ 1000000 (* (- 2) var3))) (* (- 1) 1))))) (<= 0 (+ (+ (* 1 (+ 1000000 (* (- 2) var3))) 2) (* (- 1) 1)))) (<= 0 (+ (+ (* (- 1) (+ 1000000 (* (- 2) var3))) 2) (* (- 1) 1))))) (inv_main12 var2 var1 0))))
(assert (forall ((var0 Int) (var1 AddrRange) (var2 Heap)) (or (not (and (inv_main15 var2 var1 var0) (is-O_S (readHeap var2 (nthAddrRange var1 var0))))) (inv_main12 var2 var1 (+ var0 1)))))
(assert (forall ((var0 Int) (var1 AddrRange) (var2 Heap) (var3 Int)) (or (not (and (and (inv_main12 var2 var1 var0) (<= 0 (+ (+ (* (- 1) var0) 1000000) (* (- 1) 1)))) (not (or (not (and (and (<= 0 (+ (+ (* 1 (+ 1000000 (* (- 2) var3))) 2) (* (- 1) 1))) (<= 0 (+ (+ (* (- 1) (+ 1000000 (* (- 2) var3))) 2) (* (- 1) 1)))) (not (<= 0 (+ (* (- 1) (+ 1000000 (* (- 2) var3))) (* (- 1) 1)))))) (<= 0 (+ var3 (* (- 1) var0))))))) (inv_main12 var2 var1 (+ var0 1)))))
...
(assert (forall ((var0 Int) (var1 AddrRange) (var2 Heap) (var3 Int) (var4 AddrRange) (var5 Heap)) (or (not (and (and (and (and (and (inv_main8 var5 var4 var3) (= var0 var3)) (= var1 var4)) (= var2 (writeHeap var5 (nthAddrRange var4 var3) (O_S (S 10))))) (is-O_S (readHeap var5 (nthAddrRange var4 var3)))) (is-O_S (readHeap var5 (nthAddrRange var4 var3))))) (inv_main5 var2 var1 (+ var0 1)))))
