...
(assert (forall ((var0 Int) (var1 AddrRange) (var2 Heap)) (or (not (and (batchAllocHeapPostHeap emptyHeap var2 (O_S (S nullAddr)) 1000000) (and true (= var1 (AddrRange (ite (<= 0 999999) (+ (HeapSize emptyHeap) 1) (HeapSize emptyHeap)) 1000000))))) (inv_main3 var2 var1 var0))))
...
(assert (forall ((var0 Int) (var1 Int) (var2 AddrRange) (var3 Heap) (var4 Addr) (var5 Int) (var6 Int) (var7 AddrRange) (var8 Heap)) (or (not (and (and (and (and (and (and (inv_main13 var8 var7 var6 var5 var4) (= var0 var5)) (= var1 var6)) (= var2 var7)) (= var3 (writeHeap var8 (nthAddrRange var7 var6) (O_S (S var4))))) (is-O_S (readHeap var8 (nthAddrRange var7 var6)))) (is-O_S (readHeap var8 (nthAddrRange var7 var6))))) (inv_main7 var3 var2 (+ var1 1) var0))))
(assert (forall ((var0 Int) (var1 Int) (var2 AddrRange) (var3 Heap)) (or (not (inv_main3 var3 var2 var1)) (inv_main7 var3 var2 0 var0))))
(assert (forall ((var0 Int) (var1 Int) (var2 AddrRange) (var3 Heap)) (or (not (and (inv_main7 var3 var2 var1 var0) (not (<= 0 (+ (+ (* (- 1) var1) 1000000) (* (- 1) 1)))))) (inv_main15 var3 var2 0 var0))))
(assert (forall ((var0 Int) (var1 Int) (var2 AddrRange) (var3 Heap)) (or (not (and (and (inv_main7 var3 var2 var1 var0) (<= 0 (+ (+ (* (- 1) var1) 1000000) (* (- 1) 1)))) (<= 0 (+ (+ (* (- 1) 5) var0) (* (- 1) 1))))) (inv_main15 var3 var2 0 var0))))
...
(assert (forall ((var0 Int) (var1 Int) (var2 AddrRange) (var3 Heap)) (or (not (and (and (inv_main15 var3 var2 var1 var0) (<= 0 (+ (+ (* (- 1) var1) 1000000) (* (- 1) 1)))) (not (<= 0 (+ 5 (* (- 1) var0)))))) (inv_main15 var3 var2 (+ var1 1) var0))))
(assert (forall ((var0 Int) (var1 Int) (var2 Int) (var3 AddrRange) (var4 Heap)) (or (not (and (and (inv_main7 var4 var3 var2 var1) (<= 0 (+ (+ (* (- 1) var2) 1000000) (* (- 1) 1)))) (not (<= 0 (+ (+ (* (- 1) 5) var1) (* (- 1) 1)))))) (inv_main13 (newHeap (allocHeap var4 (O_Int var0))) var3 var2 var1 (newAddr (allocHeap var4 (O_Int var0)))))))
