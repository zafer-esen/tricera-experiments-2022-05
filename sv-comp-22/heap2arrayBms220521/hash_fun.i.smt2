...
(assert (forall ((var0 Int) (var1 Addr) (var2 Heap)) (or (not (and (inv_main25 var2 var1 var0) (is-O_node (readHeap var2 var1)))) (inv_main29 var2 var1 var0 (hash (getnode (readHeap var2 var1)))))))
(assert (forall ((var0 node) (var1 Int) (var2 Int) (var3 Int) (var4 Addr) (var5 Heap)) (or (not (and (and (and (and (and (inv_main5 var5 var4 var3) (not (= var1 0))) (<= 0 (+ 1000000 (* (- 1) var3)))) (<= 0 var3)) (<= 0 (+ (+ (+ (* (- 1) var2) 100) var3) (* (- 1) 1)))) (<= 0 (+ (+ (* (- 1) var3) var2) (* (- 1) 1))))) (inv_main22 (newHeap (allocHeap var5 (O_node var0))) var4 var3 var2 1 var2 (newAddr (allocHeap var5 (O_node var0)))))))
...
(assert (forall ((var0 Addr) (var1 Int) (var2 Int) (var3 Int) (var4 Int) (var5 Addr) (var6 Heap)) (or (not (and (and (inv_main22 var6 var5 var4 var3 var2 var1 var0) (is-O_node (readHeap var6 var0))) (is-O_node (readHeap var6 var0)))) (inv_main23 (writeHeap var6 var0 (O_node (node (hash (getnode (readHeap var6 var0))) var5))) var5 var4 var3 var2 var1 var0))))
