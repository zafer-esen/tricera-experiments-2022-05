...
(assert (forall ((var0 AddrRange) (var1 AddrRange) (var2 Int) (var3 Heap) (var4 AddrRange) (var5 Int) (var6 Heap) (var7 Heap)) (or (not (and (and (batchAllocHeapPostHeap emptyHeap var6 (O_Int var5) 10000) (batchAllocHeapPostHeap emptyHeap var3 (O_Int var2) 10000)) (and (and (and (and (and (= var4 (AddrRange (ite (<= 0 9999) (+ (HeapSize emptyHeap) 1) (HeapSize emptyHeap)) 10000)) true) (= var7 emptyHeap)) (= var0 (AddrRange (ite (<= 0 9999) (+ (HeapSize emptyHeap) 1) (HeapSize emptyHeap)) 10000))) (= var1 var4)) true))) (inv_main6 var3 var1 var0 0 0))))
(assert (forall ((var0 AddrRange) (var1 AddrRange) (var2 Int) (var3 Heap) (var4 AddrRange) (var5 Int) (var6 Heap) (var7 Heap)) (or (not (and (and (and (and (and (= var4 (AddrRange (ite (<= 0 9999) (+ (HeapSize emptyHeap) 1) (HeapSize emptyHeap)) 10000)) true) (= var7 emptyHeap)) (= var0 (AddrRange (ite (<= 0 9999) (+ (HeapSize emptyHeap) 1) (HeapSize emptyHeap)) 10000))) (= var1 var4)) true)) (batchAllocHeap emptyHeap emptyHeap (O_Int var5) 10000 10000))))
(assert (forall ((var0 AddrRange) (var1 AddrRange) (var2 Int) (var3 Heap) (var4 AddrRange) (var5 Int) (var6 Heap) (var7 Heap)) (or (not (and (and (and (and (and (= var4 (AddrRange (ite (<= 0 9999) (+ (HeapSize emptyHeap) 1) (HeapSize emptyHeap)) 10000)) true) (= var7 emptyHeap)) (= var0 (AddrRange (ite (<= 0 9999) (+ (HeapSize emptyHeap) 1) (HeapSize emptyHeap)) 10000))) (= var1 var4)) true)) (batchAllocHeap emptyHeap emptyHeap (O_Int var2) 10000 10000))))
(assert (forall ((var0 Int) (var1 Int) (var2 AddrRange) (var3 AddrRange) (var4 Heap)) (or (not (and (and (and (inv_main20 var4 var3 var2 var1 var0) (is-O_Int (readHeap var4 (nthAddrRange var2 (+ (* 3 var0) 1))))) (is-O_Int (readHeap var4 (nthAddrRange var3 var0)))) (<= 0 (+ (+ (* (- 1) (+ var1 3)) 10000) (* (- 1) 1))))) (inv_main20 var4 var3 var2 (+ var1 3) (+ var0 1)))))
(assert (forall ((var0 Int) (var1 AddrRange) (var2 AddrRange) (var3 Heap) (var4 Int) (var5 Int) (var6 Int) (var7 Int) (var8 AddrRange) (var9 AddrRange) (var10 Heap)) (or (not (and (and (and (and (and (and (and (and (inv_main15 var10 var9 var8 var7 var6 var5) (= var0 var6)) (= var4 var7)) (= var1 var8)) (= var2 var9)) (= var3 (writeHeap var10 (nthAddrRange var9 var6) (O_Int var5)))) (is-O_Int (readHeap var10 (nthAddrRange var9 var6)))) (is-O_Int (readHeap var10 (nthAddrRange var9 var6)))) (not (<= 0 (+ (+ (* (- 1) (+ var4 3)) 10000) (* (- 1) 1)))))) (inv_main20 var3 var2 var1 1 0))))
...
(assert (forall ((var0 Int) (var1 Int) (var2 AddrRange) (var3 AddrRange) (var4 Heap)) (or (not (and (inv_main6 var4 var3 var2 var1 var0) (not (<= 0 (+ (+ (* (- 1) var1) 10000) (* (- 1) 1)))))) (inv_main13 var4 var3 var2 1 var0))))
(assert (forall ((var0 Int) (var1 AddrRange) (var2 AddrRange) (var3 Heap) (var4 Int) (var5 Int) (var6 Int) (var7 Int) (var8 AddrRange) (var9 AddrRange) (var10 Heap)) (or (not (and (and (and (and (and (and (and (and (inv_main15 var10 var9 var8 var7 var6 var5) (= var0 var6)) (= var4 var7)) (= var1 var8)) (= var2 var9)) (= var3 (writeHeap var10 (nthAddrRange var9 var6) (O_Int var5)))) (is-O_Int (readHeap var10 (nthAddrRange var9 var6)))) (is-O_Int (readHeap var10 (nthAddrRange var9 var6)))) (<= 0 (+ (+ (* (- 1) (+ var4 3)) 10000) (* (- 1) 1))))) (inv_main13 var3 var2 var1 (+ var4 3) (+ var0 1)))))
