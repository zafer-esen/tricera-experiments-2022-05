...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Int) (var3 Int) (var4 node) (var5 Heap) (var6 Addr) (var7 Addr) (var8 Addr) (var9 Int) (var10 Int) (var11 Heap)) (or (not (and (and (and (and (and (and (and (and (inv_main16 var11 var10 var9 var8 var7) (<= 0 (+ (+ (* (- 1) 1) var9) (* (- 1) 1)))) (= var6 (newAddr (allocHeap var11 (O_node var4))))) (= var0 var7)) (= var1 var8)) (= var2 var9)) (= var3 var10)) (= var5 (newHeap (allocHeap var11 (O_node var4))))) (= nullAddr var6))) (inv_main23 var5 var3 var2 var1 var0 var6 1))))
(assert (forall ((var0 Addr) (var1 Int) (var2 Int) (var3 Heap)) (or (not (and (and (inv_main8 var3 var2 var1 var0) (is-O_node (readHeap var3 var0))) (is-O_node (readHeap var3 var0)))) (inv_main14 (writeHeap var3 var0 (O_node (node var0 (prev (getnode (readHeap var3 var0)))))) var2 var1 var0))))
...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Int) (var3 Heap)) (or (not (and (inv_main33 var3 var2 var1 var0) (is-O_node (readHeap var3 var0)))) (inv_main36 var3 var2 var1 var0 (prev (getnode (readHeap var3 var0)))))))
(assert (forall ((var0 Addr) (var1 Addr) (var2 Int) (var3 Int) (var4 Heap)) (or (not (and (and (inv_main17 var4 var3 var2 var1 var0) (is-O_node (readHeap var4 var1))) (is-O_node (readHeap var4 var1)))) (inv_main29 (writeHeap var4 var1 (O_node (node var0 (prev (getnode (readHeap var4 var1)))))) var3 var2 var1 var0))))
...
(assert (forall ((var0 Int) (var1 Int) (var2 node) (var3 Heap) (var4 Addr) (var5 Int) (var6 Heap)) (or (not (and (and (and (and (and (inv_main3 var6 var5) (= var4 (newAddr (allocHeap var6 (O_node var2))))) (= var0 var5)) (= var1 var5)) (= var3 (newHeap (allocHeap var6 (O_node var2))))) (= nullAddr var4))) (inv_main11 var3 var1 var0 var4 1))))
...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Int) (var4 Int) (var5 Heap)) (or (not (and (and (inv_main20 var5 var4 var3 var2 var1 var0) (is-O_node (readHeap var5 var0))) (is-O_node (readHeap var5 var0)))) (inv_main26 (writeHeap var5 var0 (O_node (node var1 (prev (getnode (readHeap var5 var0)))))) var4 var3 var2 var1 var0))))
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Int) (var4 Int) (var5 Heap) (var6 Addr) (var7 Addr) (var8 Addr) (var9 Int) (var10 Int) (var11 Heap)) (or (not (and (and (and (and (and (and (and (and (inv_main26 var11 var10 var9 var8 var7 var6) (= var0 var6)) (= var1 var7)) (= var2 var8)) (= var3 var9)) (= var4 var10)) (= var5 (writeHeap var11 var7 (O_node (node (next (getnode (readHeap var11 var7))) var6))))) (is-O_node (readHeap var11 var7))) (is-O_node (readHeap var11 var7)))) (inv_main16 var5 var4 (+ var3 (* (- 1) 1)) var2 var0))))
