...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Addr) (var4 Heap)) (or (not (and (and (inv_main28 var4 var3 var2 var1 var0) (is-O_TSLL (readHeap var4 var1))) (is-O_TSLL (readHeap var4 var1)))) (inv_main27 (writeHeap var4 var1 (O_TSLL (TSLL var0 (prev (getTSLL (readHeap var4 var1))) (colour (getTSLL (readHeap var4 var1)))))) var3 var2 var1))))
...
(assert (forall ((var0 TSLL) (var1 Addr) (var2 Addr) (var3 Addr) (var4 Heap) (var5 Addr) (var6 Addr) (var7 Addr) (var8 Heap)) (or (not (and (and (and (and (and (and (inv_main23 var8 var7 var6 var5) (= var1 var5)) (= var2 var6)) (= var3 var7)) (= var4 (writeHeap var8 var5 (O_TSLL (TSLL (next (getTSLL (readHeap var8 var5))) (prev (getTSLL (readHeap var8 var5))) 0))))) (is-O_TSLL (readHeap var8 var5))) (is-O_TSLL (readHeap var8 var5)))) (inv_main28 (newHeap (allocHeap var4 (O_TSLL var0))) var3 var2 var1 (newAddr (allocHeap var4 (O_TSLL var0)))))))
...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Addr) (var4 Heap) (var5 Addr) (var6 Addr) (var7 Addr) (var8 Heap)) (or (not (and (and (and (and (and (and (inv_main97 var8 var7 var6 var5) (= var0 (next (getTSLL (readHeap var8 var6))))) (= var1 var5)) (= var2 var6)) (= var3 var7)) (= var4 var8)) (is-O_TSLL (readHeap var8 var6)))) (inv_main101 (writeHeap var4 var2 defObj) var3 var2 var0))))
...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Heap)) (or (not (and (and (and (inv_main27 var3 var2 var1 var0) (is-O_TSLL (readHeap var3 (next (getTSLL (readHeap var3 var0)))))) (is-O_TSLL (readHeap var3 (next (getTSLL (readHeap var3 var0)))))) (is-O_TSLL (readHeap var3 var0)))) (inv_main29 (writeHeap var3 (next (getTSLL (readHeap var3 var0))) (O_TSLL (TSLL (next (getTSLL (readHeap var3 (next (getTSLL (readHeap var3 var0)))))) var0 (colour (getTSLL (readHeap var3 (next (getTSLL (readHeap var3 var0))))))))) var2 var1 var0))))
...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Heap)) (or (not (and (and (inv_main30 var3 var2 var1 var0) (is-O_TSLL (readHeap var3 var0))) (is-O_TSLL (readHeap var3 var0)))) (inv_main32 (writeHeap var3 var0 (O_TSLL (TSLL var2 (prev (getTSLL (readHeap var3 var0))) (colour (getTSLL (readHeap var3 var0)))))) var2 var1 var0))))
