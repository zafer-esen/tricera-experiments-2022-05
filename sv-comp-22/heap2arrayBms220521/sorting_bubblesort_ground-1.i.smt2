...
(assert (forall ((var0 Int) (var1 Int) (var2 Int) (var3 AddrRange) (var4 Heap)) (or (not (and (and (and (inv_main19 var4 var3 var2 var1 var0) (not (<= 0 (+ (+ (* (- 1) (getInt (readHeap var4 (nthAddrRange var3 var1)))) var0) (* (- 1) 1))))) (is-O_Int (readHeap var4 (nthAddrRange var3 var1)))) (<= 0 (+ (+ (* (- 1) (+ var1 1)) 100000) (* (- 1) 1))))) (inv_main15 var4 var3 var2 (+ var1 1)))))
