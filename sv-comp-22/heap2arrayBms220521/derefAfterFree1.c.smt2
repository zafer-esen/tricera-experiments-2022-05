...
(assert (forall ((var0 Int) (var1 AddrRange) (var2 AddrRange) (var3 AddrRange) (var4 Heap) (var5 Heap) (var6 Heap)) (or (not (and (and (batchAllocHeapPostHeap var6 var4 (O_Int var0) 10) (batchWritePostHeap var4 var5 (AddrRangeStart var3) defObj (AddrRangeSize var3))) (and (and (and (and (and (inv_main2 var6) (= var3 (AddrRange (ite (<= 0 9) (+ (HeapSize var6) 1) (HeapSize var6)) 10))) true) (= var1 var3)) (= var2 var3)) true))) (inv_main4 var5 var2))))
