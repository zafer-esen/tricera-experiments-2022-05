...
(assert (forall ((var0 Int) (var1 Int) (var2 AddrRange) (var3 Heap)) (or (not (and (and (inv_main15 var3 var2 var1 var0) (is-O_Int (readHeap var3 (nthAddrRange var2 var0)))) (<= 0 (+ (+ (* (- 1) (+ var0 1)) 100000) (* (- 1) 1))))) (inv_main15 var3 var2 var1 (+ var0 1)))))
(assert (forall ((var0 AddrRange) (var1 Heap) (var2 Int) (var3 Int) (var4 AddrRange) (var5 Heap)) (or (not (and (and (and (and (and (and (inv_main10 var5 var4 var3) (= var2 var3)) (= var0 var4)) (= var1 (writeHeap var5 (nthAddrRange var4 var3) (O_Int 43)))) (is-O_Int (readHeap var5 (nthAddrRange var4 var3)))) (is-O_Int (readHeap var5 (nthAddrRange var4 var3)))) (not (<= 0 (+ (+ (* (- 1) (+ var2 1)) 100000) (* (- 1) 1)))))) (inv_main15 var1 var0 (+ var2 1) 0))))
