...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Heap) (var4 Int) (var5 Addr) (var6 Addr) (var7 Heap)) (or (not (and (and (and (and (and (and (inv_main44 var7 var6 var5 var4) (= var0 (opt (getTSLL (readHeap var7 var5))))) (= var1 var5)) (= var2 var6)) (= var3 var7)) (is-O_TSLL (readHeap var7 var5))) (= var4 2))) (and (or (not (not (= var0 var1))) (inv_main46 var3 var2 var1 1)) (or (not (= var0 var1)) (inv_main46 var3 var2 var1 0))))))
...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Heap) (var4 Int) (var5 Addr) (var6 Addr) (var7 Heap)) (or (not (and (and (and (and (and (and (and (inv_main46 var7 var6 var5 var4) (= var0 (next (getTSLL (readHeap var7 (opt (getTSLL (readHeap var7 var5)))))))) (= var1 var5)) (= var2 var6)) (= var3 var7)) (is-O_TSLL (readHeap var7 (opt (getTSLL (readHeap var7 var5)))))) (is-O_TSLL (readHeap var7 var5))) (not (= var4 0)))) (and (or (not (= var0 nullAddr)) (inv_main48 var3 var2 var1 1)) (or (not (not (= var0 nullAddr))) (inv_main48 var3 var2 var1 0))))))
