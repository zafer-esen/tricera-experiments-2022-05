...
(assert (forall ((var0 Int) (var1 AddrRange) (var2 Int) (var3 Int) (var4 Heap)) (or (not (and (and (inv_main19 var4 var3 var2 var1 var0) (not (<= 0 (+ (+ (* (- 1) var2) var3) (* (- 1) 1))))) (not (<= 0 (+ var3 (* (- 1) 1)))))) (inv_main23 var4 var3 0 var1 var0))))
(assert (forall ((var0 Int) (var1 Int) (var2 AddrRange) (var3 Heap) (var4 Int) (var5 Int) (var6 Int) (var7 AddrRange) (var8 Int) (var9 Int) (var10 Heap)) (or (not (and (and (and (and (and (and (and (and (inv_main25 var10 var9 var8 var7 var6) (= var0 (+ var6 (* (- 1) (getInt (readHeap var10 (nthAddrRange var7 var8))))))) (= var1 var6)) (= var2 var7)) (= var4 var8)) (= var5 var9)) (= var3 var10)) (is-O_Int (readHeap var10 (nthAddrRange var7 var8)))) (not (<= 0 (+ (+ (* (- 1) (+ var4 1)) var5) (* (- 1) 1)))))) (inv_main23 var3 var5 (+ var4 1) var2 var0))))
