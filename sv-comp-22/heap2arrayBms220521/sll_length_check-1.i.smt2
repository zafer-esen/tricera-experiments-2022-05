...
(assert (forall ((var0 Int) (var1 Heap)) (or (not (and (inv_main3 var1 var0) (not (<= 0 (+ (+ (* (- 1) var0) 32) (* (- 1) 1)))))) (inv_main11 var1 var0 (+ var0 1) nullAddr))))
(assert (forall ((var0 Int) (var1 Int) (var2 Heap)) (or (not (and (and (inv_main3 var2 var1) (<= 0 (+ (+ (* (- 1) var1) 32) (* (- 1) 1)))) (= var0 0))) (inv_main11 var2 var1 (+ var1 1) nullAddr))))
