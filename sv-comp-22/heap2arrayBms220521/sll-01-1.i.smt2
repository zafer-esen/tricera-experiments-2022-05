...
(assert (forall ((var0 Addr) (var1 Int) (var2 Addr) (var3 Addr) (var4 Heap) (var5 Addr) (var6 Addr) (var7 Int) (var8 Addr) (var9 Addr) (var10 Heap)) (or (not (and (and (and (and (and (and (and (and (inv_main92 var10 var9 var8 var7 var6) (= var5 (next (getTSLL (readHeap var10 var8))))) (= var0 var6)) (= var1 var7)) (= var2 var8)) (= var3 var9)) (= var4 var10)) (is-O_TSLL (readHeap var10 var8))) (not (= nullAddr var5)))) (inv_main69 var4 var3 var5 0))))
...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Heap) (var3 Addr) (var4 Addr) (var5 Heap)) (or (not (and (and (and (and (and (inv_main110 var5 var4 var3) (= var0 var3)) (= var1 var4)) (= var2 (writeHeap var5 var3 defObj))) (= nullAddr (next (getTSLL (readHeap var5 var3))))) (is-O_TSLL (readHeap var5 var3)))) (inv_main102 var2 var1 nullAddr))))
